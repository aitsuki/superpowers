...
**Note:** Execute inline by default when the user chose inline execution. Do not switch to subagent-driven development unless the user explicitly chooses it.
